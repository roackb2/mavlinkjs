...
Generated from: all.xml,ardupilotmega.xml,common.xml,icarous.xml,standard.xml,ualberta.xml,uAvionix.xml,minimal.xml
...
mavlink10.MAV_CMD_DO_UPGRADE = 247 // Request a target system to start an upgrade of one (or all) of its
...
mavlink10.MAV_CMD_DO_JUMP_TAG = 601 // Jump to the matching tag in the mission list. Repeat this action for
                        ...
                        // number.
mavlink10.MAV_CMD_PARAM_TRANSACTION = 900 // Request to start or end a parameter transaction. Multiple kinds of
...
mavlink10.MAV_CMD_DO_GIMBAL_MANAGER_TILTPAN = 1000 // High level setpoint to be sent to a gimbal manager to set a gimbal
...
mavlink10.PLANE_MODE_ENUM_END = 24 // 
...
mavlink10.GIMBAL_DEVICE_CAP_FLAGS_HAS_ROLL_LOCK = 16 // Gimbal device supports locking to an roll angle (generally that's the
...
mavlink10.GIMBAL_DEVICE_CAP_FLAGS_HAS_PITCH_FOLLOW = 64 // Gimbal device supports to follow a pitch angle relative to the vehicle
mavlink10.GIMBAL_DEVICE_CAP_FLAGS_HAS_PITCH_LOCK = 128 // Gimbal device supports locking to an pitch angle (generally that's the
...
mavlink10.GIMBAL_DEVICE_CAP_FLAGS_HAS_YAW_LOCK = 1024 // Gimbal device supports locking to an absolute heading (often this is
                        // an option available)
mavlink10.GIMBAL_DEVICE_CAP_FLAGS_SUPPORTS_INFINITE_YAW = 2048 // Gimbal device supports yawing/panning infinetely (e.g. using slip
                        // disk).
mavlink10.GIMBAL_DEVICE_CAP_FLAGS_ENUM_END = 2049 // 
...
mavlink10.GIMBAL_MANAGER_CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL = 131072 // Gimbal manager supports to point to a global latitude, longitude,
                        // altitude position.
mavlink10.GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_FOCAL_LENGTH_SCALE = 1048576 // Gimbal manager supports pitching and yawing at an angular velocity
                        // scaled by focal length (the more zoomed in,
                        // the slower the movement).
mavlink10.GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_NUDGING = 2097152 // Gimbal manager supports nudging when pointing to a location or
                        // tracking.
mavlink10.GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_OVERRIDE = 4194304 // Gimbal manager supports overriding when pointing to a location or
                        // tracking.
mavlink10.GIMBAL_MANAGER_CAP_FLAGS_ENUM_END = 4194305 // 
...
mavlink10.GIMBAL_DEVICE_FLAGS_NEUTRAL = 2 // Set to neutral position (horizontal, forward looking, with
...
mavlink10.GIMBAL_DEVICE_FLAGS_ENUM_END = 17 // 
...
mavlink10.GIMBAL_MANAGER_FLAGS_ANGULAR_VELOCITY_RELATIVE_TO_FOCAL_LENGTH = 1048576 // Scale angular velocity relative to focal length. This means the gimbal
                        // moves slower if it is zoomed in.
mavlink10.GIMBAL_MANAGER_FLAGS_NUDGE = 2097152 // Interpret attitude control on top of pointing to a location or
                        // tracking. If this flag is set, the
                        // quaternion is relative to the existing
                        // tracking angle.
mavlink10.GIMBAL_MANAGER_FLAGS_OVERRIDE = 4194304 // Completely override pointing to a location or tracking. If this flag
                        // is set, the quaternion is (as usual)
                        // according to GIMBAL_MANAGER_FLAGS_YAW_LOCK.
mavlink10.GIMBAL_MANAGER_FLAGS_NONE = 8388608 // This flag can be set to give up control previously set using
                        // MAV_CMD_DO_GIMBAL_MANAGER_ATTITUDE. This
                        // flag must not be combined with other flags.
mavlink10.GIMBAL_MANAGER_FLAGS_ENUM_END = 8388609 // 
...
mavlink10.WINCH_RELATIVE_LENGTH_CONTROL = 1 // Wind or unwind specified length of cable, optionally using specified
                        // rate.
mavlink10.WINCH_RATE_CONTROL = 2 // Wind or unwind cable at specified rate.
...
// COMP_METADATA_TYPE
mavlink10.COMP_METADATA_TYPE_VERSION = 0 // Version information which also includes information on other optional
...
mavlink10.COMP_METADATA_TYPE_COMMANDS = 2 // Meta data which specifies the commands the vehicle supports. (WIP)
mavlink10.COMP_METADATA_TYPE_ENUM_END = 3 // 

// PARAM_TRANSACTION_TRANSPORT
mavlink10.PARAM_TRANSACTION_TRANSPORT_PARAM = 0 // Transaction over param transport.
mavlink10.PARAM_TRANSACTION_TRANSPORT_PARAM_EXT = 1 // Transaction over param_ext transport.
mavlink10.PARAM_TRANSACTION_TRANSPORT_ENUM_END = 2 // 

// PARAM_TRANSACTION_ACTION
mavlink10.PARAM_TRANSACTION_ACTION_START = 0 // Commit the current parameter transaction.
mavlink10.PARAM_TRANSACTION_ACTION_COMMIT = 1 // Commit the current parameter transaction.
mavlink10.PARAM_TRANSACTION_ACTION_CANCEL = 2 // Cancel the current parameter transaction.
mavlink10.PARAM_TRANSACTION_ACTION_ENUM_END = 3 // 
...
mavlink10.MAV_SENSOR_ROTATION_ROLL_270_YAW_180 = 41 // Roll: 270, Yaw: 180
...
mavlink10.MAV_BATTERY_FAULT_ENUM_END = 65 // 
...
mavlink10.CAMERA_TRACKING_NONE = 0 // Not tracking
mavlink10.CAMERA_TRACKING_POINT = 1 // Target is a point
mavlink10.CAMERA_TRACKING_RECTANGLE = 2 // Target is a rectangle
mavlink10.CAMERA_TRACKING_MODE_ENUM_END = 3 // 

// CAMERA_TRACKING_TARGET_DATA
mavlink10.CAMERA_TRACKING_TARGET_NONE = 0 // No target data
mavlink10.CAMERA_TRACKING_TARGET_EMBEDDED = 1 // Target data embedded in image data (proprietary)
mavlink10.CAMERA_TRACKING_TARGET_RENDERED = 2 // Target data rendered in image
mavlink10.CAMERA_TRACKING_TARGET_IN_STATUS = 4 // Target data within status message (Point or Rectangle)
...
mavlink10.ZOOM_TYPE_RANGE = 2 // Zoom value as proportion of full camera range (a value between 0.0 and
                        // 100.0)
mavlink10.ZOOM_TYPE_FOCAL_LENGTH = 3 // Zoom value/variable focal length in milimetres. Note that there is no
...
mavlink10.FOCUS_TYPE_METERS = 3 // Focus value in metres. Note that there is no message to get the valid
                        ...
                        // camera).
mavlink10.SET_FOCUS_TYPE_ENUM_END = 4 // 
...
mavlink10.CELLULAR_NETWORK_FAILED_REASON_SIM_ERROR = 3 // SIM is available, but not usuable for connection
...
mavlink10.MAV_ODID_ID_TYPE_ENUM_END = 4 // 
...
mavlink10.MAV_ODID_STATUS_ENUM_END = 4 // 
...
mavlink10.MAV_ODID_AUTH_TYPE_ENUM_END = 5 // 

// MAV_ODID_DESC_TYPE
mavlink10.MAV_ODID_DESC_TYPE_TEXT = 0 // Free-form text description of the purpose of the flight.
mavlink10.MAV_ODID_DESC_TYPE_ENUM_END = 1 // 

// MAV_ODID_OPERATOR_LOCATION_TYPE
mavlink10.MAV_ODID_OPERATOR_LOCATION_TYPE_TAKEOFF = 0 // The location of the operator is the same as the take-off location.
mavlink10.MAV_ODID_OPERATOR_LOCATION_TYPE_LIVE_GNSS = 1 // The location of the operator is based on live GNSS data.
mavlink10.MAV_ODID_OPERATOR_LOCATION_TYPE_FIXED = 2 // The location of the operator is a fixed location.
...
// COMPONENT_CAP_FLAGS
mavlink10.COMPONENT_CAP_FLAGS_PARAM = 1 // Component has parameters, and supports the parameter protocol (PARAM
                        // messages).
mavlink10.COMPONENT_CAP_FLAGS_PARAM_EXT = 2 // Component has parameters, and supports the extended parameter protocol
                        // (PARAM_EXT messages).
mavlink10.COMPONENT_CAP_FLAGS_ENUM_END = 3 // 
...
mavlink10.MODE_MANUAL_DIRECT = 1 // Raw input pulse widts sent to output
mavlink10.MODE_MANUAL_SCALED = 2 // Inputs are normalized using calibration, the converted back to raw
                        // pulse widths for output
mavlink10.MODE_AUTO_PID_ATT = 3 //  dfsdfs
mavlink10.MODE_AUTO_PID_VEL = 4 //  dfsfds
mavlink10.MODE_AUTO_PID_POS = 5 //  dfsdfsdfs
mavlink10.UALBERTA_AUTOPILOT_MODE_ENUM_END = 6 // 

// UALBERTA_NAV_MODE
mavlink10.NAV_AHRS_INIT = 1 // 
mavlink10.NAV_AHRS = 2 // AHRS mode
mavlink10.NAV_INS_GPS_INIT = 3 // INS/GPS initialization mode
mavlink10.NAV_INS_GPS = 4 // INS/GPS mode
mavlink10.UALBERTA_NAV_MODE_ENUM_END = 5 // 

// UALBERTA_PILOT_MODE
mavlink10.PILOT_MANUAL = 1 //  sdf
mavlink10.PILOT_AUTO = 2 //  dfs
mavlink10.PILOT_ROTO = 3 //  Rotomotion mode
mavlink10.UALBERTA_PILOT_MODE_ENUM_END = 4 // 
...
mavlink10.MAV_TYPE_ENUM_END = 36 // 
...
mavlink10.MAVLINK_MSG_ID_PARAM_ACK_TRANSACTION = 19
...
mavlink10.MAVLINK_MSG_ID_MISSION_CHANGED = 52
...
mavlink10.MAVLINK_MSG_ID_NAV_FILTER_BIAS = 220
mavlink10.MAVLINK_MSG_ID_RADIO_CALIBRATION = 221
mavlink10.MAVLINK_MSG_ID_UALBERTA_SYS_STATUS = 222
...
*/
mavlink10.messages.param_ack_transaction = function(target_system, target_component, param_id, param_value, param_type, param_result) {

    this.format = '<fBB16sBB';
    this.id = mavlink10.MAVLINK_MSG_ID_PARAM_ACK_TRANSACTION;
    ...
    this.set(arguments);
        ...
        mavlink10.messages.param_ack_transaction.prototype = new mavlink10.message;
mavlink10.messages.param_ack_transaction.prototype.pack = function(mav) {
    return mavlink10.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.param_value, this.target_system, this.target_component, this.param_id, this.param_type, this.param_result]));
}
...
*/
mavlink10.messages.mission_changed = function(start_index, end_index, origin_sysid, origin_compid, mission_type) {

    this.format = '<hhBBB';
    this.id = mavlink10.MAVLINK_MSG_ID_MISSION_CHANGED;
    this.order_map = [0, 1, 2, 3, 4];
    this.crc_extra = 132;
    ...
    this.set(arguments);
        ...
        mavlink10.messages.mission_changed.prototype = new mavlink10.message;
mavlink10.messages.mission_changed.prototype.pack = function(mav) {
    return mavlink10.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.start_index, this.end_index, this.origin_sysid, this.origin_compid, this.mission_type]));
}
...
*/
mavlink10.messages.nav_filter_bias = function(usec, accel_0, accel_1, accel_2, gyro_0, gyro_1, gyro_2) {

    this.format = '<Qffffff';
    this.id = mavlink10.MAVLINK_MSG_ID_NAV_FILTER_BIAS;
    this.order_map = [0, 1, 2, 3, 4, 5, 6];
    this.crc_extra = 34;
    ...
    this.set(arguments);
        ...
        mavlink10.messages.nav_filter_bias.prototype = new mavlink10.message;
mavlink10.messages.nav_filter_bias.prototype.pack = function(mav) {
    return mavlink10.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.usec, this.accel_0, this.accel_1, this.accel_2, this.gyro_0, this.gyro_1, this.gyro_2]));
}
...
*/
mavlink10.messages.radio_calibration = function(aileron, elevator, rudder, gyro, pitch, throttle) {

    this.format = '<3H3H3H2H5H5H';
    this.id = mavlink10.MAVLINK_MSG_ID_RADIO_CALIBRATION;
    this.order_map = [0, 1, 2, 3, 4, 5];
    this.crc_extra = 71;
    ...
    this.set(arguments);
        ...
        mavlink10.messages.radio_calibration.prototype = new mavlink10.message;
mavlink10.messages.radio_calibration.prototype.pack = function(mav) {
    return mavlink10.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.aileron, this.elevator, this.rudder, this.gyro, this.pitch, this.throttle]));
}
...
*/
mavlink10.messages.ualberta_sys_status = function(mode, nav_mode, pilot) {

    this.format = '<BBB';
    this.id = mavlink10.MAVLINK_MSG_ID_UALBERTA_SYS_STATUS;
    this.order_map = [0, 1, 2];
    this.crc_extra = 15;
    ...
    this.set(arguments);
        ...
        mavlink10.messages.ualberta_sys_status.prototype = new mavlink10.message;
mavlink10.messages.ualberta_sys_status.prototype.pack = function(mav) {
    return mavlink10.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.mode, this.nav_mode, this.pilot]));
}
...
mavlink10.map = {
        ...
        19: { format: '<fBB16sBB', type: mavlink10.messages.param_ack_transaction, order_map: [1, 2, 3, 0, 4, 5], crc_extra: 137 },
        ...
        52: { format: '<hhBBB', type: mavlink10.messages.mission_changed, order_map: [0, 1, 2, 3, 4], crc_extra: 132 },
        ...
        220: { format: '<Qffffff', type: mavlink10.messages.nav_filter_bias, order_map: [0, 1, 2, 3, 4, 5, 6], crc_extra: 34 },
        221: { format: '<3H3H3H2H5H5H', type: mavlink10.messages.radio_calibration, order_map: [0, 1, 2, 3, 4, 5], crc_extra: 71 },
        222: { format: '<BBB', type: mavlink10.messages.ualberta_sys_status, order_map: [0, 1, 2], crc_extra: 15 },
