...
mavlink20.PLANE_MODE_ENUM_END = 24 // 
...
mavlink20.MAV_BATTERY_FAULT_ENUM_END = 65 // 
...
mavlink20.messages.smart_battery_info = function(id, battery_function, type, capacity_full_specification, capacity_full, cycle_count, serial_number, device_name, weight, discharge_minimum_voltage, charging_minimum_voltage, resting_minimum_voltage) {
    ...
    this.format = '<iiiHHHHHBBB50s';
    this.id = mavlink20.MAVLINK_MSG_ID_SMART_BATTERY_INFO;
    this.order_map = [8, 9, 10, 0, 1, 3, 2, 11, 4, 5, 6, 7];
    this.crc_extra = 124;
...
mavlink20.map = {
        ...
        370: { format: '<iiiHHHHHBBB50s', type: mavlink20.messages.smart_battery_info, order_map: [8, 9, 10, 0, 1, 3, 2, 11, 4, 5, 6, 7], crc_extra: 124 },
